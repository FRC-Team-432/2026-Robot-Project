...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    // Shooter speed adjusts automatically based on AprilTag area (closer = slower, farther = faster).
    // Both shooter wheels + feeder run simultaneously; everything stops on trigger release.
