...
public class Superstructure extends SubsystemBase {
   ...
   * area of the target — closer (larger area) = slower, farther (smaller area) = faster.
   *
   * @param areaSupplier Supplier for current target area (0-100 from getTA())
