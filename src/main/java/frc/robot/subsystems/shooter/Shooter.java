 ...
 * <ul>
 *   <li>{@link #spinWhileHeld()} — fixed speed, for teleop trigger binding (fallback)
 *   <li>{@link #spinAtAreaWhileHeld(DoubleSupplier)} — speed adjusts automatically
 *       based on AprilTag area, for area-based teleop shooting
 *   <li>{@link #spinUpForArea(DoubleSupplier)} — instant area-based spinup for auto
 * </ul>
 *
...
public class Shooter extends SubsystemBase {
  ...
  // Separate instance for the follower — Phoenix 6 uses per-instance trajectory state,
  // so sharing velocityOut between two motors corrupts the internal ramp calculations.
