 ...
 *       based on AprilTag area from the Limelight
 *   <li>{@link #spinUpForArea(DoubleSupplier)} — instant command that sets speed
 *       based on tag area, for use in auto sequences
 * </ul>
 *
...
public class Shooter extends SubsystemBase {
  ...
  /** Stop both shooter motors by commanding zero velocity so the target is properly zeroed. */
  private void stop() {
