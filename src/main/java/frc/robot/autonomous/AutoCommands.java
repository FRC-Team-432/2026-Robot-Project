...
public class AutoCommands {
  ...
  // Robot-centric request for vision-based driving blocks
   ...
   * <ul>
   *   <li>a) Center tag is primary target → P-control on TX with camera offset correction
   *   <li>b) A different tag is primary (side tag) → spin toward it using TX sign
   *   <li>c) No tag visible → slow fallback spin
   * </ul>
   *
